...
The possibility that moral judgments track irrelevant factors like disgust at the moment of evaluation is (to me, at least) alarming. But now that you've been baited, we can move on the boring, obligatory formalities.

## What are moral judgments?

A moral judgment is a belief that some moral proposition is true or false. It is the output of a process of moral reasoning. When I agree with the claim "Murder is wrong.", I'm making a moral judgment.

::: {.skippable}
Quite a bit of work in the area talks about moral intuitions rather than moral judgments. Moral intuitions are more about the immediate sense of something than about the all-things-considered, reflective judgment. One model of the relationship between intuitions and judgments is that intuitions are the raw material which are refined into moral judgments by more sophisticated moral reasoning. We will talk predominately about moral judgments because: 
...
3. It's not clear that moral intuitions and moral judgments are always distinct. There is reason to believe that, at least for some people some of the time, moral intuitions are not refined before becoming moral judgments.
:::

## What would it mean for moral judgments to be unreliable?

The simplest case of unreliable judgments is when precisely the same moral proposition is evaluated differently at different times. If I tell you that "Murder is wrong." today and "Murder is right." tomorrow, my judgments are very unreliable indeed.
...
[^time]: The first, simplest sort of unreliability can be subsumed in this framework by considering time of evaluation a morally irrelevant factor.
...
<blockquote>
The [Restrictionist] Challenge, in a nutshell, is that the evidence of the [human philosophical instrument]’s susceptibility to error makes live the hypothesis that the cathedra lacks resources adequate to the requirements of philosophical enquiry. [[@d2017cambridge]]{.attribution}
</blockquote>
...
Given that, the overall statement of the [Unreliability of Moral Judgment Problem (UMJP)]{#umjp} looks like this:
...
3. Therefore, for some people, in some circumstances, moral judgments track factors they ought not to.
...
(When we examine each of the putatively irrelevant moral factors below, for the sake of brevity, I'll assume it's obvious why there's at least a *prima facie* case for irrelevance.)
...
3. I searched for "reliability of moral intuition" on [Google Scholar](https://scholar.google.com/) and selected relevant papers based on their titles and abstract.
...
There were also several studies that examined people's responses to Kahneman and Tversky's [Asian disease scenario](https://en.wikipedia.org/wiki/Framing_(social_sciences)#Experimental_demonstration). Even though this scenario has a strong moral dimension, I excluded these experiments on the grounds that any strangeness here was most likely (as judged by my intuitions) a result of non-normative issues (i.e. failure to actually calculate or consider the full implications of the scenario).
...
Here are the quantitive results:
...
| :------                                      | :------                        | :------                    | :----                              | :------                       | ----:       |
| [@petrinovich1996influence], study 2, form 1 | Ordering of inaction vs action | 6-point scale of agreement | 30 vs 29                          | $F(1, 57) = 0.37$; $p > 0.10$ |             |
| [@petrinovich1996influence], study 2, form 2 | Ordering of inaction vs action | 6-point scale of agreement | 30 vs 29                          | $F(1, 57) = 5.07$; $p < 0.02$ |             |
| [@haidt1996social], mazda                    | Ordering of act vs omission    | Rating act worse           | [45.5 vs 45.5]{.noted}[^estimate] | $\chi^2 = 7.32$; $p < 0.01$   |             |
| [@haidt1996social], crane                    | Ordering of act vs omission    | Rating act worse           | 34.5 vs 34.5                      | $\chi^2 = 0.50$; TODO         |             |
| [@haidt1996social], mazda                    | Ordering of social roles       | Rating friend worse        | 45.5 vs 45.5                      | $\chi^2 = 3.25$; $p < 0.05$   |             |
| [@haidt1996social], crane                    | Ordering of social roles       | Rating foreman worse       | 34.5 vs 34.5                      | $\chi^2 = 3.91$; $p < 0.05$   |             |
</figure>

TODO

[^estimate]: The half is an estimate because 91 subjects were described as being evenly split the conditions.

<figure>
![TODO](/images/moral-intuitions/order-forest.png)
<figcaption>Forest plot showing reported effect sizes (scaled by sample size) for order manipulations</figcaption>
</figure>

<figure>
![TODO](/images/moral-intuitions/order-funnel.png)
<figcaption>Funnel plot showing reported effect sizes (scaled by sample size) for order manipulations</figcaption>
</figure>
...
| Study                                      | Independent variable | Dependent variable         | Sample size | Result               | Effect size |
| :------                                    | :------              | :------                    |     :------ | :------              | ------:             |
| [@petrinovich1993empirical], general class | Wording of vignettes | 6-point scale of agreement |         361 | $F(1, 359) = 296.51$ | $\eta_p^2 = 0.45$   |
| [@petrinovich1993empirical], biomeds       | Wording of vignettes | 6-point scale of agreement |          60 | $F(1, 57) = 18.07$   | $\eta_p^2 = 0.24$   |
</figure>

It's worth noting that in other studies in other domains framing effects have disappeared when problems were more fully described [@kuhberger1995framing]. [@kuhn1997communicating] found that even wordings which were plausibly equivalent led subjects to alter their estimates of implicit probabilities in vignettes.
...
After disgust or cleanliness is induced (in the non-control subjects), subjects are asked to evaluate some moral hypothetical. The claim is that their responses will be different because talk of moral purity and disgust is not merely metaphorical---feelings of cleanliness and disgust at the time of evaluation have a causal effect on moral evaluations. Confusingly, the exact nature of this putative relationship seems rather protean: it depends subtly on whether the subject or the object of a judgment feels clean/disgusted and can be mediated by private body consciousness or response effort.
...
That said, here are the quantitative results:

<figure class="big-fig">
<figcaption>Studies of moral intuitions and disgust or cleanliness effects</figcaption>
| Study                                 | Independent variable                    | Dependent variable                    | Sample size             | Result                             | Effect size |
| :------                               | :------                                 | :------                               | :------                 | :------                            | ------:     |
| [@wheatley2005hypnotic], experiment 1 | Hypnotic disgust cue                    | 0-100 rating of vignette wrongness    | 45                      | $t(44) = 2.41$; $p < 0.05$         |             |
| [@wheatley2005hypnotic], experiment 2 | Hypnotic disgust cue                    | 0-100 rating of vignette wrongness    | 63                      | $t(62) = 1.74$; $p < 0.05$         |             |
| [@schnall2008clean], experiment 1     | Clean word scramble                     | 0-9 rating of vignette wrongness      | 20 vs 20                | $f(1, 38) = 3.63$; TODO            |             |
| [@schnall2008clean], experiment 2     | Disgusting movie clip                   | 0-9 rating of vignette wrongness      | 22 vs 22                | $f(1, 41) = 7.81$; TODO            |             |
| [@johnson2014does], experiment 1      | Clean word scramble                     | 0-9 rating of vignette wrongness      | 114.5 vs 114.5          | $f(1, 206) = 0.004$; $p = 0.95$    |             |
| [@johnson2014does], experiment 2      | Washing hands                           | 0-9 rating of vignette wrongness      | 58 vs 68                | $f(1, 124) = 0.001$; $p = 0.97$    |             |
| [@johnson2016effects], study 1        | Describe disgusting memory              | 0-9 rating of vignette wrongness      | 222 vs 256              | $f(1, 474) = 0.04$; $p = 0.84$     |             |
| [@johnson2016effects], study 2        | Describe disgusting memory              | 0-9 rating of vignette wrongness      | 467 vs 467              | $f(1, 926) = 0.48$; $p = 0.48$     |             |
| [@schnall2008disgust], experiment 1   | Fart spray                              | 7-point Likert scale of vignette      | 42.3 vs 42.3 vs 42.3    | $f(2, 117) = 7.43$; $p < 0.001$    |             |
| [@schnall2008disgust], experiment 2   | Disgusting room                         | 9-point scale of vignette appropriacy | 22.5 vs 22.5            | [Not significant]{.noted}[^info]   |             |
| [@schnall2008disgust], experiment 3   | Describe disgusting memory              | 9-point scale of vignette appropriacy | 33.5 vs 33.5            | Not significant                    |             |
| [@schnall2008disgust], experiment 4   | Disgusting vs sad vs neutral movie clip | 9-point scale of vignette appropriacy | 43.3 vs 43.3 vs 43.3    | $f(1, 104) = 4.11$; $p < 0.05$     |             |
| [@huang2014does], study 1             | Clean word scramble                     | 0-9 rating of vignette wrongness      | 111 vs 103              | $t(212) = -1.22$; $p = 0.23$       |             |
| [@huang2014does], study 2             | Clean word scramble                     | 0-9 rating of vignette wrongness      | 211 vs 229              | $t(438) = -0.42$; $p = 0.68$       |             |
| [@liljenquist2010smell], experiment 1 | Clean scent in room                     | Money returned                        | 14 vs 14                | $t(26) = 2.64$; $p = 0.01$         |             |
| [@liljenquist2010smell], experiment 2 | Clean scent in room                     | 1-7 scale of volunteering interesting | 49.5 vs 49.5            | $t(97) = 2.33$; $p = 0.02$         |             |
| [@liljenquist2010smell], experiment 2 | Clean scent in room                     | Willingness to donate                 | 49.5 vs 49.5            | $\chi^2(1, 99) = 4.78$; $p = 0.03$ |             |
| [@zhong2010clean], experiment 1       | Antiseptic wipe for hands               | 11-point scale of immoral to moral    | 29 vs 29                | $t(56) = 2.10$; $p = 0.04$         |             |
| [@zhong2010clean], experiment 2       | Visualize clean vs dirty and nothing    | 11-point scale of immoral to moral    | 107.6 vs 107.6 vs 107.6 | $t(320) = 2.02$; $p = 0.045$       |             |
| [@zhong2010clean], experiment 2       | Visualize dirty vs nothing              | 11-point scale of immoral to moral    | 107.6 vs 107.6 vs 107.6 | $t(320) = 0.42$; $p = 0.675$       |             |
| [@zhong2010clean], experiment 3       | Visualize clean vs dirty                | 11-point scale of immoral to moral    | 68 vs 68                | $t(134) = 2.13$; $p = 0.04$        |             |
| [@tobia2013cleanliness], undergrads   | Clean scent on survey                   | 1-7 scale of wrongness                | 84 vs 84                | $f(1, 164) = 8.56$; $p = 0.004$    |             |
| [@tobia2013cleanliness], philosophers | Clean scent on survey                   | 1-7 scale of wrongness                | 58.5 vs 58.5            | Not significant                    |             |
</figure>
...
<figcaption>Forest plot showing reported effect sizes (scaled by sample size) for disgust/cleanliness manipulations</figcaption>
</figure>

<figure>
![Funnel plot of disgust/cleanliness studies](/images/moral-intuitions/clean-funnel.png)
<figcaption>Funnel plot showing reported effect sizes (scaled by sample size) for disgust/cleanliness manipulations</figcaption>
</figure>
...
Studies on this issue typically just send surveys to people and analyze how the results vary depending on gender.
...
| :------                                                       | :------              | :------                                    | :------     | :------                        |
| [@seyedsayamdost2015gender], plank of Carneades, MTurk        | Gender               | 7-point scale                              | 70 vs 86    | $t(154) = -1.302$, $p = 0.195$ |
| [@seyedsayamdost2015gender], plank of Carneades, SurveyMonkey | Gender               | 7-point scale                              | 48 vs 50    | $t(96) = 0.727$, $p = 0.469$   |
| [@adleberg2015men], violinist                                 | Gender               | 7-point scale from forbidden to obligatory | 52 vs 84    | $t(134) = -0.39$, $p = 0.70$   |
| [@adleberg2015men], magistrate and the mob                    | Gender               | 5-point scale from bad to good             | 71 vs 87    | $t(156) = -0.28$, $p = 0.78$   |
| [@adleberg2015men], trolley switch                            | Gender               | 7-point scale of acceptability             | 52 vs 84    | $t(134) = 0.26$, $p = 0.34$    |
</figure>

## Culture and socioeconomic status

There's just one study here. It tested responses to moral vignettes across high and low socioeconomic status samples in Philadelphia, USA and Porto Alegre and Recife, Brazil.
...
In these studies, one version of the vignette has some anonymous third party as the central figure in the dilemma. The other version puts the survey's subject in the moral dilemma. For example, "Should Bob throw the trolley switch?" versus "Should you throw the trolley switch?".
...
| [@tobia2013cleanliness], undergrads                  | Actor vs observer    | 1-7 scale of wrongness         | 84 vs 84     | $f(1, 164) = 15.24$; $p < 0.0001$                                                          |
| [@tobia2013cleanliness], philosophers                | Actor vs observer    | 1-7 scale of wrongness         | 58.5 vs 58.5 | Not significant                                                                            |
</figure>

# Indirect evidence

Given that the direct evidence is far from definitive, it may be useful to look at some indirect evidence. By that, I mean we'll look at (among other things) some underlying theories about how moral intuitions operate and what bearing they have on the question of reliability.

(Pro-tip: Each of the following sub-headings is more or less independent so you can dip in and out as desired.)

## Heuristics and biases

No complex human faculty is perfectly reliable. This is no surprise and perhaps not of great import.

But we have evidence that some faculties are not only "not perfect" but systematically and significantly biased. The heuristics and biases program (heavily associated with Kahneman and Tversky) of research has [shown]{.noted}[^caveat] serious limitations in human rationality. A review of that literature is out of scope here, but the list of alleged aberrations is extensive. [Scope insensitivity](https://en.wikipedia.org/wiki/Scope_neglect)---the failure of people, for example, to care twice as much about twice as many oil-covered seagulls---is one example I find compelling.
...
How much bearing this has on moral judgments depends on how tight you think the analogy is. On one point of view, there's little overlap. Instrumental rationality as studied in the heuristics and biases program is purely about means---given a goal, how is it best achieved---while morality is about ends---what should our goals be. The other point of view (which I find more persuasive) suggests that there's significant overlap between the faculties. Most day-to-day moral judgments don't call for us to reconsider our ultimate ends. Instead, these judgments are about what actions we should take in the moment in service of our ultimate ends. Judgments of that sort sound much closer to the means-based domain of rationality. From this perspective, there may not even be a clear division between instrumental rationality and moral judgments about which actions to perform---merely a gradient of how salient prudential concerns are versus moral concerns. 

At a minimum, prominent heuristics and biases researcher Gerd Gigerenzer endorses the hypothesis that heuristics underlying moral behavior are "largely" the same as heuristics underlying other behavior [@gigerenzer2008moral]. "Moral intuitions fit the pattern of heuristics, in our "narrow" sense, if they involve (a) a target attribute that is relatively inaccessible, (b) a heuristic attribute that is more easily accessible, and (c) an unconscious substitution of the target attribute for the heuristic attribute." Condition (a) is satisfied by many accounts of morality. Given that, it seems unlikely that there are zero available heuristic attributes as described in condition (b) or that the substitution described in (c) fails to happen only in the domain of moral judgments.

## Neural

The previous section argued for a similarity between moral judgment and a process known to be unreliable at both the computational level (What problem is the mind trying to solve?) and the algorithmic level (What computations does the mind perform to solve this problem?). Now we'll look at unreliability at the neural level.
...
For both tasks, leading models (as far as I understand things) are fundamentally stochastic.

Judgment tasks are best described by the random utility model in which, upon introspection, an actor samples from a distribution of possible valuations for an option rather than finding a single, fixed valuation [@glimcher2005physiological]. This makes sense at the neuronal level because liking is encoded as the firing rate of a neuron and firing rates are stochastic.

Choice tasks are best described by the drift diffusion model in which the current disposition to act starts at 0 on some axis and takes a biased random walk (drifts) [@ratcliff2008diffusion]. Away from zero, on two opposite sides, are thresholds representing each of the two options. Once the current disposition drifts past a threshold, the corresponding option is chosen. Because of the random noise in the drift process, there's no guarantee that the threshold favored by the bias will always be the first one crossed. Again, the randomness in this model makes sense because neurons are stochastic.
...
(There's a lot more research on this topic:  TODO
Boyd & Richerson (1992); Henrich & Boyd (2001); Boyd et al. (2003); Gintis et al. (2003); Richerson et al. (2003); Richerson & Boyd (2005); Boyd & Mathew (2007); Hauert et al. (2007). Ruse & Wilson (1985), Ruse (1986), Dennett (1995: chs. 16–17), Kitcher (1998), Singer (2000), and Levy (2004).)
...
Researchers have made similar claims about morality [@sripada2008nativism]. The argument is that children learn moral rules without enough moral experience to precisely specify all the details of those rules. Therefore, they must have a universal moral grammar---innate faculties that encode certain possible moral rules. There are of course arguments against this claim. Briefly: moral rules are much less complex than languages, and language learning must be inductive while moral learning can include explicit instruction.
...
- The second type of response questions the external validity of the studies thereby asserting that the "some"s in premise 2 are narrow enough to defuse any real threat in the conclusion.
...
First, it seems to be the case that not all domains are conducive to the development of expertise. For example, training and experience do not produce expertise at psychiatry and stock brokerage according to [@dawes1994psychotherapy] [@shanteau1992competence]. Clear, immediate and objective feedback appears necessary for the formation of expertise [@shanteau1992competence]. Unfortunately, it's hard to construe whatever feedback is available to moral philosophers considering thought experiments and edge cases as clear, immediate and objective [@clarke2013intuitions] [@weinberg2007challenge].

Second, "one of the most enduring findings in the study of expertise [is that there is] little transfer from high-level proficiency in one domain to proficiency in other domains---even when the domains seem, intuitively, very similar" [@feltovich2006studies]. Chess experts have excellent recall for board configurations, but only when those configurations could actually arise during the course of a game [@degroot2014]. Surgical expertise carries over very little from one surgical task to another [@norman2006expertise]. Thus, evidence of improved [cognitive reflection is not a strong indicator of improved moral judgment]{.noted}[^reflection]. Nor is evidence of philosophical excellence on any task other than moral judgment itself likely to be particularly compelling.
...
Finally, there is direct empirical evidence that [philosophers moral judgments continue to track putatively morally irrelevant factors]{.noted}[^moral-philosophers]. TODO ([@schulz2011persistent] find similar results for another type of philosophical judgment).
...
So, in sum, while there's an immediate appeal to the expertise defense---we can trust intuitions honed by years of philosophical work, it looks quite troubled upon deeper examination.
...
The second set of responses to this attempted defusal is as follows. Even if experiments only measured shifts in degree of approval or disapproval, that would be worrying because:

- Real moral decisions often involve trade-offs between two wrongs or two rights and the degree of rightness or wrongness of each constituent in such dilemmas may determine the final judgment rendered. [@andow2016reliable]
- Much philosophical work involves thought experiments on the margin where approval and disapproval are closely balanced [@wright2016intuitional]. Even small effects from improper sources at the border can lead to the wrong judgment. Wrong judgments on these marginal thought experiments can cascade to more mundane and important judgments if we take them at face value.
...
One could perhaps make an analogous argument for moral judgments: though they don't always conform to the dictates of ideal theory, they are near optimal given the environment in which they operate.
...
Other interesting work in this area includes [@weinberg2012intuition] [@weinberg2017knowledge] [@talbot2014so].
...
Any studies mentioned in the quantitative review and not mentioned here had nothing that immediately struck me as troublesome.
...
:   How many times can you pull the same trick on people? You kind of have to hope the answer is "A lot" for this study since it used a repeated measures design asking each subject 17 questions in sequence testing the order sensitivity of several different scenarios. The authors do acknowledge the possibility for learning effects.
...
:    Hypnosis seems pretty weird. I'm not sure how much external validity hypnotically-induced disgust has. Especially after accounting for the fact that the results only include those who were successfully hypnotized---it seems possible that those especially susceptible to hypnosis are different from others in some way that is relevant to moral intuitions.
...
:    In experiment 1, the mean moral judgment in the mild-stink condition was not significantly different from the mean moral judgment in the strong-stink condition despite a significant difference in mean disgust. This doesn't seem obviously congruent with the underlying theory and it seems slightly strange that this possible anomaly passed completely unmentioned.
     ...
     The non-significant results we report were not, apparently, the authors' main interest. Their primary hypothesis (which the experiments supported) was that disgust would increase severity of moral judgment for subjects high in private body consciousness [@miller1981consciousness].
...
:   The cleanliness manipulation in experiment 1 seems very weak. Subjects completed a scrambled-sentences task with 40 sets of four words. Control condition participants received neutral words while cleanliness condition participants had cleanliness and purity related words in half their sets. 
    ...
    The experimenters went on to find that cleanliness reduced the severity of moral judgment which, as discussed elsewhere, seems a bit worrying.
...
[@johnson2014does]
:    Wow, much power--0.99. This is a failed replication of [@schnall2008clean] and I feel better about its internal validity.

[@johnson2016effects]
:    The power level for study 1, it's over 99.99%! This is a failed replication of [@schnall2008disgust] and I feel better about its internal validity.
...
:   They have a pretty complicated study design here: it's three-way ANOVA crossing expertise (philosophers versus students), agent (actor versus observer) and cleanliness (clean versus control) and they don't talk about any corrections for multiple comparisons.
