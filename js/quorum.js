...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jStat__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jStat___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jStat__);
...
var yHistLims = function (yss) {
  ...
  return [__WEBPACK_IMPORTED_MODULE_0_jStat___default.a.min(ys) * 0.8, __WEBPACK_IMPORTED_MODULE_0_jStat___default.a.max(ys) * 1.2];
};
var xHistLims = function (xss) {
  // flatten xs_
  var xs = [].concat.apply([], xss);
  return [__WEBPACK_IMPORTED_MODULE_0_jStat___default.a.min(xs), __WEBPACK_IMPORTED_MODULE_0_jStat___default.a.max(xs)];
};
...
var histogramCounts = function (xs) {
  var l = xs.length;
  var min = __WEBPACK_IMPORTED_MODULE_0_jStat___default.a.min(xs);
  var max = __WEBPACK_IMPORTED_MODULE_0_jStat___default.a.max(xs);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_flot__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_flot___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery_flot__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jStat__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jStat___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_jStat__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_libs_colors__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_libs_plot__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_libs_mcmc__ = __webpack_require__(18);
/* eslint no-undef: "off" */
...
const plotOptions = {
  ...
  legend: {
    ...
    color: __WEBPACK_IMPORTED_MODULE_3_libs_colors__["a" /* default */].bodyText
  },
  grid: {
    backgroundColor: null,
    color: __WEBPACK_IMPORTED_MODULE_3_libs_colors__["a" /* default */].bodyText
  },
  colors: __WEBPACK_IMPORTED_MODULE_3_libs_colors__["a" /* default */].chroma.slice(1)
};
const interval = [-1, 1];

const plotMcmcHist = (jq, paramData, conf, preds = []) => {
  let barData;
  let plotOpts = __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.extend(true, {}, plotOptions);
  const data = [];
  if (conf.log === true) {
    const logTrans = {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.extend(plotOpts.xaxis, logTrans);
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.extend(plotOpts.yaxis, logTrans);
  }
  ...
  if (typeof conf.xlims === 'object' && conf.xlims !== null) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.extend(plotOpts.xaxis, lims(conf.xlims));
  }
  if (typeof conf.ylims === 'object' && conf.ylims !== null) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.extend(plotOpts.yaxis, lims(conf.ylims));
  }
  ...
  if (paramData.length !== 0) {
    barData = __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].histogramCounts(paramData);
  ...
  const percSmallerLarger = (comp, data) => {
    const percLarger = __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.mean(__WEBPACK_IMPORTED_MODULE_2_jStat___default.a.map(data, x => x >= comp ? 1 : 0));
  ...
  const HDI = (c, x) => {
    x = x.sort((a, b) => a - b);
    const nbrPoints = Math.floor(x.length * c);
    let [min, max] = [__WEBPACK_IMPORTED_MODULE_2_jStat___default.a.min(x), __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.max(x)];
    let width;
  ...
  if (typeof conf.di !== 'undefined' && conf.di !== null) {
    const intervAdd = (c, [min, max]) => {
      data.push({
        data: [[min, __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].getHeight(min === interval[0] ? max : min, barData)], [max, __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].getHeight(max === interval[1] ? min : max, barData)]],
  ...
  if (typeof paramData.length !== 'undefined' && paramData.length !== 0) {
    const mean = __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.mean(paramData);
  ...
  return __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.plot(jq, data, plotOpts);
};

const best = ds => {
  const showResult = chain => {
    inputGraph(__WEBPACK_IMPORTED_MODULE_5_libs_mcmc__["a" /* default */].posterior_predictive_check(chain));
    progress(0.925);

    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#stat-out').show();
    plotMcmcHist(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#mean > div'), __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].twoDArrayCol(chain, 2), { di: 'BI', comp: 0, xlims: [-1, 1] });
    progress(0.95);

    const a = __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].twoDArrayCol(chain, 0);
    const b = __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].twoDArrayCol(chain, 1);
    const xlims = __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].xHistLims([a, b]);
    const ylims = __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].yHistLims([a, b]);
    plotMcmcHist(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#alpha > div'), a, { di: 'HDI', xlims, ylims, log: true });
    progress(0.975);
    plotMcmcHist(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#beta > div'), b, { di: 'HDI', xlims, ylims, log: true });
    progress(1);
  };
  const progress = x => {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('progress').attr('value', x);
  };

  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.analyze').html('Re-analyze');
  __WEBPACK_IMPORTED_MODULE_5_libs_mcmc__["a" /* default */].run_BEST(ds, 20000, 20000, progress, showResult);
};
...
const freq = ds => {
  ...
  const mean = __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.mean(ds);
  const stdev = __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.stdev(ds);
  const cis = __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].sampleFunc(-1, 1, mu => __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.studentt.pdf((mean - mu) / stdev * Math.sqrt(l), dof));
  const ci = conf => {
    const bound = __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.studentt.inv(conf, dof) * stdev / Math.sqrt(l);
    const y = __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.studentt.pdf(__WEBPACK_IMPORTED_MODULE_2_jStat___default.a.studentt.inv(conf, dof), dof);
    if (mean > 0) {
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#stat-out').show();
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.plot(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#freq > div'), data, plotOptions);
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('progress').attr('value', 1);
};

const getData = check => {
  const stringToNums = s => {
    s = s.replace(/[^-1234567890.]+$/, '').replace(/^[^-1234567890.]+/, '');
    return __WEBPACK_IMPORTED_MODULE_2_jStat___default.a.map(s.split(/[^-1234567890.]+/), x => {
  ...
  let y1, y2;
  try {
    y1 = stringToNums(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#data1').val());
    y2 = stringToNums(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#data2').val());
  } catch (err) {
...
const inputGraph = pred => {
  ...
  const ylims = __WEBPACK_IMPORTED_MODULE_4_libs_plot__["a" /* default */].yHistLims(ys);
  plotMcmcHist(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#preview1 > div'), ys[0], { xlims: [0, 1], ylims });
  plotMcmcHist(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#preview2 > div'), ys[1], { xlims: [0, 1], ylims });
  plotMcmcHist(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#diff > div'), ys[2], { xlims: [-1, 1] }, pred);
};

__WEBPACK_IMPORTED_MODULE_1_jquery___default()(() => {
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.act > .analyze').click(() => {
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.preview').click(() => {
    inputGraph();
  });
  ...
  const plotOpts = {
    grid: { show: false },
    colors: [__WEBPACK_IMPORTED_MODULE_3_libs_colors__["a" /* default */].value[3]]
  };
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.plot(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#non-norm'), [{
    bars: { show: true },
    data: [[-2, 4], [-1, 1], [0, 0], [1, 1], [2, 4]]
  }], plotOpts);
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.plot(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#sym1'), [{
    bars: { show: true },
    data: [[-2, 1], [-1, 0], [0, 0], [1, 2], [2, 0]]
  }], plotOpts);
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.plot(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('#sym2'), [{ bars: { show: true },
...
"use strict";
let colors = {
  hue: ['#b5bae6', '#d1abe6', '#e6abd0', '#e6bcb5', '#dee2b5', '#b5e2b5', '#b5e2df'],
  chroma: ['#d7d6e6', '#b5bbe6', '#919fe6', '#6d84e6', '#4769e6', '#1d4de6'],
  value: ['#b5bbe6', '#9090b8', '#6b6688', '#443c56', '#18121e']
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jStat__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jStat___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jStat__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_libs_plot__ = __webpack_require__(9);
/* eslint camelcase: "off" */
...
var posterior_predictive_check = function (chain) {
  ...
  for (var i = 0; i < n_post; i++) {
    ...
    preds.push(__WEBPACK_IMPORTED_MODULE_1_libs_plot__["a" /* default */].sampleFunc(-1, 1, function (x) {
...
var generalized_beta = function (x, a, b, interval) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_jStat___default.a.beta.pdf(normed, a, b);
};
var run_BEST = function (ys, n_samples_, n_burnin, progress_cb, final_cb) {
  ...
  var amwg = function (start_values, posterior) {
    ...
    var derived_params = function (p) {
      ...
      return interval[0] + __WEBPACK_IMPORTED_MODULE_0_jStat___default.a.beta.mean(p[0], p[1]) * (interval[1] - interval[0]);
    };
    var next_sample = function () {
      chain.push(curr_state.concat(derived_params(curr_state)));

      for (var param_i = 0; param_i < n_params; param_i++) {
        var param_prop = __WEBPACK_IMPORTED_MODULE_0_jStat___default.a.normal.sample(curr_state[param_i], Math.exp(log_sd[param_i]));
  ...
  var make_BEST_posterior_func = function (data) {
    return function (params) {
      ...
      var beta = params[1];
      var log_p = 0;
      log_p += Math.log(__WEBPACK_IMPORTED_MODULE_0_jStat___default.a.exponential.pdf(alpha, 1));
      log_p += Math.log(__WEBPACK_IMPORTED_MODULE_0_jStat___default.a.exponential.pdf(beta, 1));
